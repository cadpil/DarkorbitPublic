...
function ship.new(shipInstance : Instance, shipModules : table)
    ...
    for moduleName, moduleValues in pairs(shipModules) do
        ...
        if not modulesTable[moduleName] then continue end
        ...
        newShip.modules[moduleName] = modulesTable[moduleName].new(moduleValues.Size, moduleValues.Class)
    end
